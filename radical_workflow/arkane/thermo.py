...
def run_arkane_thermo(mol_id, smi, row_index, df, model_chemistry, subinputs_dir, suboutputs_dir, scratch_dir, RMG_path):
    # current dir
    ...
    make_arkane_species_thermo_input_files(mol_id, smi, xyz, freq_path, sp_path, model_chemistry, use_bond_corrections=True)
...
def make_arkane_species_thermo_input_files(mol_id, smi, xyz, freq_path, sp_path, model_chemistry, use_bond_corrections=True):

    arkane_species_input_path = make_arkane_species_input_file(smi, xyz, freq_path, sp_path, model_chemistry, use_bond_corrections=use_bond_corrections)
